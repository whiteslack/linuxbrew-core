class Envchain < Formula
  ...
  bottle do
    ...
    sha256 "0a280127849e99bf3313f5d43b7bf1bf38cbffde964ca1c4e3968728b8a52cc8" => :arm64_big_sur
    ...
    sha256 "f24f674a86e50307c6b42796f5850925c193fe8e7aaaa1219061f747397ed7a6" => :x86_64_linux
  end
