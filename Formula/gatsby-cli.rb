...
class GatsbyCli < Formula
  ...
  bottle do
    ...
    sha256 "a5bb2975e7487adae2d18caa1694abd2844c56e2d7200a96a1f101f155ce78a9" => :x86_64_linux
  end
  ...
  def install
    ...
    rm_f "#{libexec}/lib/node_modules/gatsby-cli/node_modules/websocket/builderror.log" unless OS.mac?
  end
