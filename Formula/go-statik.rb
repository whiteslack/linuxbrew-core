class GoStatik < Formula
  ...
  bottle do
    ...
    sha256 "4145ac4e53df5a059490bfeada7c7503752780ffd68f217902255d44651c209c" => :x86_64_linux
  end
  ...
  test do
    ...
    font_path = OS.mac? ? "/Library/Fonts/#{font_name}" : "/usr/share/fonts/truetype/dejavu/DejaVuSans.ttf"
