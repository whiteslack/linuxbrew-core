class Gssh < Formula
  ...
  bottle do
    ...
    sha256 "31f745f57d10191ea547bdcfbbf544342a09b87a51b4298114baacc9f35589a0" => :big_sur
    ...
    sha256 "2662564e64158ee7767688f0dd639e6260d9b391ec0f4ac2a286a302409151e0" => :x86_64_linux
  end
