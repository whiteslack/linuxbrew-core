class HttpLoad < Formula
  ...
  bottle do
    cellar :any
    sha256 "67456aed34ccc1d9873b946ed2adb7c86ecd52ad90a495f9527afd0a883710d0" => :big_sur
    sha256 "d5fc5ba0ce6baf991e45fcb70f6e2fd3153e1f902d1d510cf015b3ff8cc4d0c3" => :arm64_big_sur
    ...
    sha256 "30aacd4e7c9db8332f96f490a653b0955aaeaddfe35fcde7aa1218187c044803" => :x86_64_linux
  end
