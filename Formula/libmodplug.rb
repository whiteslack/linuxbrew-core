class Libmodplug < Formula
  ...
  bottle do
    ...
    sha256 "56844963830a01d60ec8c62aa492d92cde11b7fdf548b5f41f576e0d548e7728" => :arm64_big_sur
    ...
    sha256 "a267c9306a29ae0b5987eec09cdb090712f8b2c94f5b8a97d62e68dd5ee56309" => :x86_64_linux
  end
  ...
  test do
    ...
    mv "downloads.php?moduleid=60395", "downloads.php" unless OS.mac?
