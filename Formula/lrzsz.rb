class Lrzsz < Formula
  ...
  bottle do
    ...
    sha256 "af1dde66f4c633e9fdfa3b5108987626f79d3f8e3c5efc80b55f29c4720cef04" => :arm64_big_sur
    ...
    sha256 "a5b6cde48e1f28aaa5c8191787fbadd6dca2e5cbd6eb8b7e1ddbe0b290296015" => :x86_64_linux
  end
