class Pcre2 < Formula
  ...
  bottle do
    ...
    sha256 "b766062678cc87e2be559c4a22859a6e100a56e00d2d08320ac26f36ba9390ad" => :arm64_big_sur
    ...
    sha256 "007ed1174fb49a9a74740ba89a0a6d4306139fff907108dfa6dea43666d3d9d0" => :x86_64_linux
  end
