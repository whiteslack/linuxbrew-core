class Pms < Formula
  ...
  bottle do
    ...
    sha256 "c119951216c45f24ff265bb5046631b6cbd5730300b8f4d441e7ac2be1363fcd" => :arm64_big_sur
    ...
    sha256 "8696449a4eedb33228b49209278efbb68f90d13f9894cfea5cc37687d88d0b78" => :x86_64_linux
  end
