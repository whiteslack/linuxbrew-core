class Pyqt < Formula
  ...
  bottle do
    ...
    sha256 "e249a0671617a14bfca478211779e3c96b5a7397700b49b74aec54112e9cec52" => :x86_64_linux
  end
  ...
  test do
    ...
    m.each { |mod| system Formula["python@3.9"].opt_bin/"python3", "-c", "import PyQt5.Qt#{mod}" }
  end
end
