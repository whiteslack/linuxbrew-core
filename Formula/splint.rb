class Splint < Formula
  ...
  bottle do
    ...
    sha256 "229d18ade0e3dfc1c9ed796732a57bb385de5dfd8c15d3b265c4ef42cfd5f765" => :arm64_big_sur
    ...
    sha256 "6132cf1e74b5fc0b6be6ef69d193dbf53fd72d5f67f90013f84bcbfd01f26c0e" => :x86_64_linux
  end
