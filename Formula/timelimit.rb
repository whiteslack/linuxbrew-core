class Timelimit < Formula
  ...
  bottle do
    ...
    sha256 "9f890d907623dd9b857710b9d7eb1d3256ba0ba7f620576a28313522343b648f" => :arm64_big_sur
    ...
    sha256 "06c8bc26194174d1ac8bf52c7086f76378b469b015bd2ca422ce093290faa578" => :x86_64_linux
  end
