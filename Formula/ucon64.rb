class Ucon64 < Formula
  ...
  bottle do
    ...
    sha256 "f42d1062bd7c4f5e405b4fc6d9f4d8b556275e1b5cbef6cfe132e4f986255e82" => :x86_64_linux
  end
  ...
  def install
    ...
    inreplace "src/ucon64_misc.c", "PROPERTY_MODE_DIR (\"ucon64\") \"discmage.#{ext}\"",
                                   "\"#{opt_prefix}/libexec/libdiscmage.#{ext}\""
    ...
    cd "src" do
      ...
      system "make"
      bin.install "ucon64"
      libexec.install "libdiscmage/discmage.#{ext}" => "libdiscmage.#{ext}"
    end
  end
