class Uhd < Formula
  ...
  bottle do
    ...
    sha256 "7b1198d0d922c96a9a06a9258a34c099b19c657c1de6aa5cdaa65428130fc648" => :x86_64_linux
  end
  ...
  def install
    ...
    mkdir "host/build" do
      system "cmake", "..", *std_cmake_args, "-DENABLE_STATIC_LIBS=#{OS.mac? ? "ON" : "OFF"}", "-DENABLE_TESTS=OFF"
      system "make"
      system "make", "install"
    end
  end
